...
def ls_solution(customers, depot, vehicle_capacity, vehicle_count):
    ...
    # For Q.4
    schedule = {'tmax': 1000.0, 'tmin': 0.1, 'steps': 1000, 'updates': 700}
    tps_schedule = {'tmax': 10000.0, 'tmin': 0.1, 'steps': 10000, 'updates': 0}
    tps_update = 50
...
def solve_it(input_data):
    ...
    # For Q.4
    km_customers, clustered_idxs = kmeans_clusterting(customers)
    # analyze(customers)
    ...
    # vehicle_tours = mip_solution(customers, depot, vehicle_capacity, vehicle_count, customer_count)
    vehicle_tours = ls_solution(km_customers, depot, vehicle_capacity, vehicle_count)
    ...
    # For Q.4
    vehicle_tours = expand_kmeans(vehicle_tours, clustered_idxs, customers)
    # print(f"{check_capacity_constraint(vehicle_tours, vehicle_capacity)=}")
    ls_tsp(vehicle_tours, customers)
